...
#define GROUP_14 "\xff\xff\xff\xff\xff\xff\xff\xff\xc9\x0f\xda\xa2\x21\x68\xc2\x34" \
...
typedef struct _dh_ctx{
    bn_t *prime; //Prime
    bn_t *generator; //Generator number
    bn_t *x; //private random number between [2,prime2-];
    bn_t *X; //public number
} dh_ctx;
